...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] dev/js/components/App.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] dev/js/components/Display.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-8d2a743c/Display.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] dev/js/components/Increment.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-e2674fe2/Increment.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
		vuex: {
			actions: {
				...
				decrement: _actions.decrementCounter
			}
		}
	};
...
/***/ function(module, exports) {
	...
	var incrementCounter = exports.incrementCounter = function incrementCounter(_ref, payload) {
	...
	var decrementCounter = exports.decrementCounter = function decrementCounter(store) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testPlugin = __webpack_require__(15);

	var _count = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var testPlugin = exports.testPlugin = function testPlugin(store) {
		var prevState = (0, _assign2.default)({}, store.state);
		store.subscribe(function (mutation, state) {
			console.log((true));
...
/***/ function(module, exports) {
	...
	var mutations = {
		...
		DECREMENT: function DECREMENT(state, amount) {
			state.count = state.count - amount;
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = {
		INIT_ALL: function INIT_ALL(state, payload) {
			state.all = [].concat((0, _toConsumableArray3.default)(state.all), (0, _toConsumableArray3.default)(payload));
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(24)(IteratorPrototype, __webpack_require__(69)('iterator'), function(){ return this; });
