...
<style lang="sass">
	...
	.search-input{margin-top: 20px;position: relative;
		.search-btn, .search-change, #sg{position: absolute;}
		...
		.search-engine{top: 45px; left: 6px; width: 90px; height: auto; background-color: rgba(255,255,255, .8); border-radius: 8px; overflow: hidden;}
		...
		#sg{width: 525px;height: auto;top: 45px;left: 17px;border-radius: 10px;overflow: hidden; background-color: rgba(255,255,255,.82);}
